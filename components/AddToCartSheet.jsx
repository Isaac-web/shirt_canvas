    ...
    <div className="md:w-1/2  p-8 md:ml-20">
      <div className="p-10 glassmorphism rounde xl w-full container max-w-xl m-auto">
        ...
        <p className="text-xs text-gray-700">
          Please continue by specifying the details below.
        </p>
        <h3 className="font-bold text-3xl mt-4 mb-7">
          Ghc {(price * quantity).toFixed(2)}
        </h3>
        <p className="text-xs text-gray-700 mb-3">
          The shirt as shown comes with different sizes and two types of
          texture. <br className="max-md:hidden" /> Please specify below.
        </p>
        ...
        <div className="w-full md:w-3/4 mb-5">
          ...
          <div className="flex gap-16 justify-between items-center">
            <button
              onClick={handleDec}
              className="w-[60px] md:w-14 h-10 bg-black text-white rounded-l-full"
            >
              -
            </button>
            <div className="w-auto">
              ...
              {!inputShown && (
                <p
                  className="font-semibold p-5 cursor-pointer"
            ...
            <button
              onClick={handleInc}
              className="w-[60px] md:w-14 h-10 bg-black text-white rounded-r-full"
            >
              +
            </button>
          </div>
